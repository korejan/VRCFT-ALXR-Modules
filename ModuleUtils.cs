...
namespace ALXR
{
    public static class ModuleUtils
    {
        ...
        public static void UpdateMouthExpressionsFB(ref UnifiedExpressionShape[] unifiedExpressions, ReadOnlySpan<float> expressions)
        {
            ...
            unifiedExpressions[(int)UnifiedExpressions.MouthUpperUpLeft].Weight      = Math.Min(1.0f, TrackingSensitivity.MouthUpperUp * Math.Max(0.0f, expressions[(int)FBExpression.Upper_Lip_Raiser_L] - expressions[(int)FBExpression.Nose_Wrinkler_L])); // Workaround for wierd tracking quirk.
            unifiedExpressions[(int)UnifiedExpressions.MouthUpperDeepenLeft].Weight  = Math.Min(1.0f, TrackingSensitivity.MouthUpperUp * Math.Max(0.0f, expressions[(int)FBExpression.Upper_Lip_Raiser_L] - expressions[(int)FBExpression.Nose_Wrinkler_L])); // Workaround for wierd tracking quirk.
            unifiedExpressions[(int)UnifiedExpressions.MouthUpperUpRight].Weight     = Math.Min(1.0f, TrackingSensitivity.MouthUpperUp * Math.Max(0.0f, expressions[(int)FBExpression.Upper_Lip_Raiser_R] - expressions[(int)FBExpression.Nose_Wrinkler_L])); // Workaround for wierd tracking quirk.
            unifiedExpressions[(int)UnifiedExpressions.MouthUpperDeepenRight].Weight = Math.Min(1.0f, TrackingSensitivity.MouthUpperUp * Math.Max(0.0f, expressions[(int)FBExpression.Upper_Lip_Raiser_R] - expressions[(int)FBExpression.Nose_Wrinkler_L])); // Workaround for wierd tracking quirk.
